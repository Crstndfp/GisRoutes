...
{
    public partial class ViwAniversarioBodas
    {
        ...
        public string UbicacionPredefinida { get; set; }
        public string TiendaRetener { get; set; }
        ...
        public string DireccionNovio { get; set; }
        ...
        public string DireccionNovia { get; set; }
    }
}
